...
1. Clone or download and unzip the repository from github https://github.com/amoskipz/Blog-app.git

2. You can use this command (git clone https://github.com/amoskipz/Blog-app.git) to clone the project to your machine if you have git .
